...
public class Product {
  ...
  /**
   * Constructs a new product with the specified parameters, setting the createdAt and updatedAt
  ...
  /**
   * Sets the category of the product and updates the updatedAt timestamp.
   *
  ...
  /**
   * Sets the price of the product and updates the updatedAt timestamp.
   *
   ...
   * whenever any attribute of the product is modified.
   */
  private void update() {

...
export function Summary({items = [], onOrderSubmit},props) {
    ...
    const handlePostInputChanged = (e) => setOrder({...order, postcode: e.target.value })
        ...
        <React.Fragment>
            ...
            <form id ="frm">
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control"value={order.postcode} onChange={handlePostInputChanged} id="postcode"/>
                </div>
